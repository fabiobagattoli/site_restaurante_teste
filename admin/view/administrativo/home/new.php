...
try {
	$query_novo = $conecta->prepare('INSERT INTO paginas (Nome,Obs,Tipo) 

VALUES (:Nome,:Obs,:Tipo)');
...
$query_novo = NULL;
 ...
 echo "<script>window.location = 'index.php?acao=alterar-principal&id=$idreal&msg=1'</script>";
exit;
...
<div classe="page-header">
  ...
  <div class="widget-box">
    <div class="widget-header">
      <h4 class="widget-title">Titulo topo da página</h4>
    ...
    <div class="form-group has-info">
     ...
     <form name="novo" action="" enctype="multipart/form-data" method="post">
        ...
        <div>
															...
															<textarea class="form-control" name="Obs" id="form-field-8" placeholder="Digite aqui"><?php echo $Obs; ?></textarea>
