<?php include('conect_dbs.php'); 
 ...
 // Extensões permitidas
  ...
  $caminho = '../public/imagelogo/';
	...
	$query_update = $conecta->prepare("UPDATE conf SET logorecibo = :logorecibo WHERE ok = :ok");
	$query_update->bindValue(':ok' , 's' , PDO::PARAM_STR);
	$query_update->bindValue(':logorecibo' , $nomeAleatorio , PDO::PARAM_STR);
    $query_update->execute();

       echo "<meta HTTP-EQUIV='refresh' CONTENT='0;URL=index.php?acao=empresa&msg=2'>";
