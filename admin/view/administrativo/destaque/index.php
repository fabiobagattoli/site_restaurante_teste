...
<form id="formfiltro" name="formfiltro" method="post" target="_self">
	...
	<div class="widget-header">
      <h4 class="widget-title">Destaques</h4>
    ...
    <div class="form-group has-info">
		 ...
		 <table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="index.php?acao=alterar-destaque&id=<?php echo $artigo->id_pagina; ?>"><?php echo $artigo->id_pagina; ?></a>
													</td>
													...
													<td>
														...
														<a href="index.php?acao=alterar-destaque&id=<?php echo $artigo->id_pagina; ?>"	<button class="btn btn-xs btn-success">
																 <i class="ace-icon fa fa-check bigger-120"></i> 
															</button> </a>

															<a href="index.php?acao=alterar-destaque&id=<?php echo $artigo->id_pagina; ?>" <button class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</button> </a>

															<a href="index.php?acao=deletar-destaque&id=<?php echo $artigo->id_pagina; ?>" <button class="btn btn-xs btn-danger">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a href="index.php?acao=alterar-destaque&id=<?php echo $artigo->id_pagina; ?>" class="tooltip-info" data-rel="tooltip" title="Ver">
																			<span class="blue">
																	...
																	<li>
																		<a href="index.php?acao=alterar-destaque&id=<?php echo $artigo->id_pagina; ?>" class="tooltip-success" data-rel="tooltip" title="Editar">
																			<span class="green">
																	...
																	<li>
																		<a href="index.php?acao=deletar-destaque&id=<?php echo $artigo->id_pagina; ?>" class="tooltip-error" data-rel="tooltip" title="Excluir">
																			<span class="red">
																				<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			</span>
																		</a>
      ...
      for ($i=$range_inicial; $i <= $range_final; $i++):   
        ...
        ?>   
        <a class="btn btn-info btn-sm" <?=$destaque?>' href="index.php?acao=destaque&page=<?=$i?>"><?=$i?></a>    
        &nbsp;&nbsp;
      <?php endfor; ?>    
